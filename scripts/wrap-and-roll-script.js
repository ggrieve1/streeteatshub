...
document.addEventListener("DOMContentLoaded", function() {
    ...
    function fetchData() {
        fetch('../json/wrap-and-roll.json') // Adjust the path to your JSON file
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    menuImage.addEventListener('click', function() {
      ...
      enlargedMenu = document.createElement('div');
      enlargedMenu.classList.add('enlarged-menu');
  
      const enlargedImage = document.createElement('img');
      enlargedImage.src = menuImage.src;
      enlargedImage.alt = menuImage.alt;
      enlargedMenu.appendChild(enlargedImage);
      document.body.appendChild(enlargedMenu);
  
      enlargedMenu.addEventListener('click', function() {
        enlargedMenu.remove();
        enlargedMenu = null;
      });
    });
